...
public class VendasCotroller implements Controller_Interfaces<Venda> {
    ...
    ObservableList<CarroVenda> funcionalvenda = FXCollections.observableArrayList();
	...
	public VendasCotroller() {
		TableColumn<CarroVenda, Integer> col1 = new TableColumn<>("Codº Vendedor");
...
//        table.getColumns().addAll(col1, col2, col3, col4, col5, col6, col7, col8, col9);
	...
	public void pesquisar() {
		...
		System.out.println(funcionalvenda.toString());
	}
